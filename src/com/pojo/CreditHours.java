...
private String creditHourList;

private String creditHourLow;
...
public void setCreditHourList(String creditHourList){
this.creditHourList = creditHourList;
}
public String getCreditHourList(){
return this.creditHourList;
}
public void setCreditHourLow(String creditHourLow){
this.creditHourLow = creditHourLow;
}
public String getCreditHourLow(){
